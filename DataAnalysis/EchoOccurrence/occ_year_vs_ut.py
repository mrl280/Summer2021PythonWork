...
def occ_year_vs_ut(station, year_range, hour_range=None, gate_range=None, beam_range=None,
    ...
    for row in range(n_rows):
        ...
        ax[row].set_ylabel(year_range[0] + row)
    ...
    for row in range(n_rows):
        ...
        df_yy['ydata'] = (df_yy['month'] - 1) / 12 + (df_yy['day'] - 1) / 365 + df_yy['xdata'] / 8760

        # TODO: Compute the median of a parameter if one is given
...
if __name__ == '__main__':
    ...
    station = "rkn"
    fig = occ_year_vs_ut(station=station, year_range=(2013, 2015),
